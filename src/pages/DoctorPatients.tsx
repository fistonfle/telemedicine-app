...
import { fetchDoctorPatients } from "../store/slices/doctorSlice";
import type { DoctorPatient } from "../types";

function DoctorPatients() {
  const dispatch = useAppDispatch();
  const { patients: patientsList, loading, error } = useAppSelector((s) => s.doctor);
  const [searchQuery, setSearchQuery] = useState("");

  useEffect(() => {
    dispatch(fetchDoctorPatients(searchQuery));
